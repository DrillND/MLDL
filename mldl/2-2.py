'''
    numpy 머신러닝에서는 fit 함수(학습하는 함수)를
    ...
    최근접이웃분류
    좌료를 주면 그 주위에 제일 가까운 좌표를 구해서... 어떤 부류에 속하는지 계산해주는 클래스
    
    matplotlib.pyplot as plt
    scatter 산점도.. 그래프 그리는 것
...
# fish_data = [[l,w] for l, w in zip(fish_length,fish_weight)] 밑에랑 동일
...
'''
    ...
    x 좌표축의 데이터 범위와 y 좌표축의 데이터범위가 다를때에는
    데이터전처리..
    표준점수로.. 구해주어야한다....
